-- Create real-time campus activity tables (fixed)
...
-- Real-time facility occupancy (without building_id foreign key for now)
...
CREATE INDEX idx_facility_occupancy_building ON facility_occupancy(building_name, facility_type);
...
INSERT INTO facility_occupancy (building_name, facility_name, facility_type, current_occupancy, max_capacity) VALUES
('Central Library', 'Study Area', 'library', 45, 120),
('Central Library', 'Computer Lab A', 'computer_lab', 12, 30),
('Recreation Center', 'Main Gym', 'gym', 78, 150);
